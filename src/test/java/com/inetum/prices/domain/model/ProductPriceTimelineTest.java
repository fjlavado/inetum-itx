...
class ProductPriceTimelineTest {
        ...
        void shouldRejectNullProductId() {
                ...
                // When & Then
                assertThrows(DomainValidationException.class, () -> new ProductPriceTimeline(null, BRAND_ID, rules));
        }
        ...
        void shouldRejectNullBrandId() {
                ...
                // When & Then
                assertThrows(DomainValidationException.class, () -> new ProductPriceTimeline(PRODUCT_ID, null, rules));
        }
        ...
        void shouldRejectNullApplicationDate() {
                ...
                // When & Then
                assertThrows(DomainValidationException.class, () -> timeline.getEffectivePrice(null));
        }
        ...
        void shouldReturnUnmodifiableRulesList() {
                ...
                assertThrows(UnsupportedOperationException.class, () -> retrievedRules.add(createPriceRule(99, 99,
