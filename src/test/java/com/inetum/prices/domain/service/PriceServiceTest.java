 ...
 * <p>
 * These tests focus on domain logic in isolation, using Mockito to mock the
 * repository.
 * No Spring context is loaded - these are fast, pure unit tests.
 * <p>
 * Tests have been updated to use ProductPriceTimeline aggregate instead of
 * individual Price entities.
 */
...
class PriceServiceTest {
        ...
        void shouldThrowExceptionWhenTimelineNotFound() {
                ...
                // When / Then
                assertThatThrownBy(() -> priceService.getApplicablePrice(applicationDate, productId, brandId))
        ...
        void shouldThrowExceptionWhenApplicationDateIsNull() {
                ...
                // When / Then
                assertThatThrownBy(() -> priceService.getApplicablePrice(null, productId, brandId))
        ...
        void shouldThrowExceptionWhenProductIdIsNull() {
                ...
                // When / Then
                assertThatThrownBy(() -> priceService.getApplicablePrice(applicationDate, null, brandId))
                                .isInstanceOf(DomainValidationException.class)
        ...
        void shouldThrowExceptionWhenBrandIdIsNull() {
                ...
                // When / Then
                assertThatThrownBy(() -> priceService.getApplicablePrice(applicationDate, productId, null))
                                .isInstanceOf(DomainValidationException.class)
